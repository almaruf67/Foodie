                    ...
                    <div class="col-xl-6">
                        <div class="d-flex align-items-center">
                            <div class="content-header me-5">
                                ...
                                <h4>Phone:<a href="callto:+1(850)344066">+88 01595643223</a></h4>
                            </div>
                            <div class="content-header">
                                ...
                                <h4>Email:<a href="mailto:+1(850)344066">info@foodio.com</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="d-flex align-items-center login">
                            ...
                            <div class="register dropdown">
                                ...
                                @guest
                                    ...
                                    @endif
                                @else
                                    <a id="navbarDropdown" class="dropdown-toggle" type="button" id="dropdownMenuButton1"
                                ...
                                <div class="cart-popup pr-5">
                                            ...
                                            @foreach (session('cart') as $id => $details)
                                                <li class="d-flex align-items-center position-relative">
                                                    ...
                                                    <div class="p-img light-bg">
                                                        ...
                                                        <img src="{{ asset($details['poster']) }}"
                                                            alt="Product Image" height="75px">
                                                    ...
                                                    <div rowdel="{{ $id }}" class="actions">
                                                        <a
                                                            class="btn btn-outline-danger delete-product position-absolute bottom-50 end-0"><i
                                    ...
                                    <div class="cart-btns d-flex align-items-center justify-content-between">
                                        ...
                                        <a class="font-bold theme-bg-clr text-white checkout"
                                            href="{{ route('checkout', $total) }}">Checkout</a>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6">
                    <div class="logo-white">
                        <a href="{{ route('home') }}"><img alt="logo-white"
                                src="{{ asset('assets/img/logo-white.png') }}"></a>
                ...
                <div class="col-xl-2 col-lg-3 col-md-6">
                    <div class="link-about">
                        <h3>About</h3>
                        <ul>
                            <li><i class="fa-solid fa-angle-right"></i><a href="{{ route('about') }}">Information</a>
                            </li>
                            ...
                            <li><i class="fa-solid fa-angle-right"></i><a href="{{ route('contact') }}">Contact</a>
                            </li>
                        </ul>
                    </div>
                </div>
